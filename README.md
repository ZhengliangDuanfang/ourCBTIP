...
运行指令参考：`python train_main.py -d CB-DB -sp 811-1 --model_filename CB-DB-test.model --gpu 2 --alpha_loss 1 --beta_loss 0.3 --gamma_loss 0.001 --delta_loss 1 --constant 0.5 -lr 0.001 --max_epoch 500`
