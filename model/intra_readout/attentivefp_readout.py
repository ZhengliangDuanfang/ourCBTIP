...
# 文档 https://lifesci.dgl.ai/api/model.readout.html#module-dgllife.model.readout.attentivefp_readout
# 源代码 https://github.com/awslabs/dgl-lifesci/blob/master/python/dgllife/model/readout/attentivefp_readout.py
# 经比对无实质性差别
